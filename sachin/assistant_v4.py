    ...
    try:
        ...
        try:
            if system == "Windows":
                ...
                print(f"Autoplay not supported on {system}. Please open {temp_path} manually.")
                return
            # Wait for the playback to complete (subprocess.run waits for completion)
        except Exception as e:
...
# Modified chat function with TTS
def chat_with_qwen3():
    messages = []
    print("Starting voice-activated continuous chat session with background image processing and TTS.")
        ...
        while True:
            ...
            try:
                ...
                if hasattr(response_message, "tool_calls") and response_message.tool_calls:
                    ...
                    # Generate and play speech for the response
